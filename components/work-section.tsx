...
export function WorkSection() {
  ...
  return (
    <section ref={sectionRef} id="work" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      {/* 内容区域：左侧眼睛动画，右侧对话 */}
      <div className="flex flex-col lg:flex-row min-h-[220px] lg:min-h-[500px] items-stretch gap-8 lg:gap-12 w-full lg:w-[80%]">
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="pt-5 border-t border-white/10">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6">
            <div>
              <h4 className="font-mono text-xs lg:text-sm uppercase tracking-[0.15em] text-white/70 mb-2">What I do</h4>
              <p className="text-white/60 text-sm lg:text-base leading-relaxed">前端开发 / UI设计 / 产品思考</p>
            </div>
            <div>
              <h4 className="font-mono text-xs lg:text-sm uppercase tracking-[0.15em] text-white/70 mb-2">How I work</h4>
              <p className="text-white/60 text-sm lg:text-base leading-relaxed">注重细节/追求简洁/持续迭代</p>
            </div>
            <div>
              <h4 className="font-mono text-xs lg:text-sm uppercase tracking-[0.15em] text-white/70 mb-2">What I care about</h4>
